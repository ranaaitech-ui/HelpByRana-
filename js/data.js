// ============================================================
//  Help By Rana â€” Data Layer (v3)
//  Edit this file to add/remove workers and categories.
// ============================================================

const CATEGORIES = [
    { id: 1, name: "Plumber", icon: "ðŸ”§", emergency: true },
    { id: 2, name: "Electrician", icon: "âš¡", emergency: true },
    { id: 3, name: "AC Repair", icon: "â„ï¸", emergency: true },
    { id: 4, name: "Generator Repair", icon: "ðŸ”Œ", emergency: true },
    { id: 5, name: "Carpenter", icon: "ðŸªš", emergency: false },
    { id: 6, name: "Painter", icon: "ðŸŽ¨", emergency: false },
    { id: 7, name: "Cleaner", icon: "ðŸ§¹", emergency: false },
    { id: 8, name: "Driver", icon: "ðŸš—", emergency: false },
    { id: 9, name: "Mechanic", icon: "ðŸ”©", emergency: false },
    { id: 10, name: "Barber", icon: "ðŸ’ˆ", emergency: false },
    { id: 11, name: "Welder", icon: "ðŸ”¥", emergency: false },
    { id: 12, name: "Tailor", icon: "ðŸ§µ", emergency: false },
    { id: 13, name: "Gardener", icon: "ðŸŒ¿", emergency: false },
    { id: 14, name: "Photographer", icon: "ðŸ“·", emergency: false },
    { id: 15, name: "Mobile Repair", icon: "ðŸ“±", emergency: false },
    { id: 16, name: "Appliance Repair", icon: "ðŸ–¥ï¸", emergency: false },
    { id: 17, name: "Locksmith", icon: "ðŸ”‘", emergency: false },
    { id: 18, name: "Laundry Worker", icon: "ðŸ‘•", emergency: false },
    { id: 19, name: "Delivery Worker", icon: "ðŸ“¦", emergency: false },
    { id: 20, name: "Security Guard", icon: "ðŸ›¡ï¸", emergency: false },
    { id: 21, name: "Cook", icon: "ðŸ‘¨â€ðŸ³", emergency: false },
    { id: 22, name: "Tutor", icon: "ðŸ“š", emergency: false },
];

const WORKERS_DATA = [
    // â”€â”€ PLUMBER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ ELECTRICIAN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ AC REPAIR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ GENERATOR REPAIR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ CARPENTER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ CLEANER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ MECHANIC â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ BARBER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ WELDER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ TAILOR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ GARDENER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ PHOTOGRAPHER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ LOCKSMITH â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ LAUNDRY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ DELIVERY WORKER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id: 33, name: "Kamran Delivery", category: "Delivery Worker", city: "Lahore", area: "All Areas", phone: "0303-5556677", experience: 3, rating: 4.3, reviews: 22, price: "Rs. 100â€“500", verified: false, available: true, whatsapp: "923035556677", photo: "https://ui-avatars.com/api/?name=Kamran+Delivery&background=059669&color=fff&size=128", description: "Reliable delivery boy for parcels, documents, and household items within city.", skills: ["Bike Delivery", "City-wide", "Fast", "Tracking"] },

    // â”€â”€ SECURITY GUARD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ COOK â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ TUTOR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    { id: 36, name: "Sir Aqeel Tutor", category: "Tutor", city: "Islamabad", area: "G-9", phone: "0311-4445566", experience: 5, rating: 4.6, reviews: 26, price: "Rs. 400/hour", verified: true, available: true, whatsapp: "923114445566", photo: "https://ui-avatars.com/api/?name=Aqeel+Tutor&background=2563EB&color=fff&size=128", description: "Home tutor for grades 1â€“12. Math, Science, English, and Urdu.", skills: ["Math", "Science", "English", "Urdu", "O-Levels"] },
];
...
// â”€â”€ localStorage DB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const db = {
    _getRegistry() {
        try {
    ...
    // Called from register.html â€” saves as PENDING (not visible on public site)
    addWorker(w) {
    ...
    // Admin adds worker directly â€” saves as APPROVED immediately
    addWorkerDirect(w) {
        const reg = this._getRegistry();
        const newId = Date.now();
        reg.push({
    ...
    getWorkerReviews(workerId) {
        try {
            const raw = localStorage.getItem(\hbr_reviews_\\);
            return raw ? JSON.parse(raw) : [];
        } catch { return []; }
    },
    ...
    submitReview(workerId, review) {
        ...
        localStorage.setItem(\hbr_reviews_\\, JSON.stringify(reviews));
